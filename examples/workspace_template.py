...
# Example usage:
def main():
    # Create a VectorStrategist workspace
    vs_workspace = WorkspaceTemplate.create_vectorstrategist_workspace()
    
    # Create a custom workspace
    custom_template = WorkspaceTemplate("custom_project")
    custom_workspace = custom_template.build_workspace(
        domains=["python", "machine_learning"],
        custom_config={
    ...
    custom_template.save_workspace_state(
        custom_workspace,
        save_path="./workspace_states"
    )
    
    # Load workspace state later
    loaded_workspace = WorkspaceTemplate.load_workspace_state(
        "custom_project",
        load_path="./workspace_states"
    )
